package com.xiaomianshi.core.aop;

import com.xiaomianshi.core.annotation.LoggerManager;
...
public class LoggerAdvice {
    ...
    @Before("within(com.xiaomianshi..*) && @annotation(loggerManage)")
    ...
    @AfterReturning("within(com.xiaomianshi..*) && @annotation(loggerManage)")
    public void addAfterReturningLogger(JoinPoint joinPoint, LoggerManager loggerManage) {
        logger.info("执行 " + loggerManage.desc() + " 结束");
    }

    @AfterThrowing(pointcut = "within(com.xiaomianshi..*) && @annotation(loggerManage)", throwing = "ex")
