<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form>
        <el-form-item>
          <el-button type="primary" icon="plus" v-if="$hasPerm('admin_user:add')" @click="showCreate">添加
          </el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" label="最近修改时间" prop="lastModifyTime" width="170"></el-table-column>
      <el-table-column align="center" label="管理" width="220" v-if="$hasPerm('admin_user:update')">
        <template slot-scope="scope">
...
<script>
  ...
  export default {
    ...
    created() {
      this.getList();
      if (this.$hasPerm('admin_user:add') || this.$hasPerm('admin_user:update')) {
        this.getAllRoles();
      }
    },
    computed: {
